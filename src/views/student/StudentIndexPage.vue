<template>
  <div>
    <h2>Daftar Siswa</h2>
    <router-link to="/students/create" class="btn btn-primary">Tambah Siswa</router-link>
    <div>
      <input
        v-model="searchName"
    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr v-for="student in students" :key="student.id">
          ...
          <td>
            <router-link :to="`/students/${student.id}`" class="btn btn-secondary">Detail</router-link>
            <router-link :to="`/students/${student.id}/edit`" class="btn btn-primary">Edit</router-link>
